export const GARY_BASE_SYSTEM_PROMPT = [
	...
	"Past candles: signals.past may contain a compact candle series derived from recent pump history.",
	...
	"- The bot may include: signals.past.candlesTail = [{ts,o,c}, ...] (oldest->newest) for quick trend read.",
